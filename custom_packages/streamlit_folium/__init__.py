...
def folium_static(fig,width=700, height=500,colors=['#5e4fa2', '#89d0a4', '#fffebe', '#f88c51', '#9e0142'],
                  labels=['Muito Baixo', 'Baixo', 'Médio', 'Médio - Alto', 'Alto'], title='Titulo'):
...
def st_folium(
    fig: folium.Map, key: str = None, height: int = 700, width: int = 500,
...
# Adiciona legenda fora do mapa
def add_categorical_legend(title, colors, labels):
    ...
    return components.html(html=legend_html, width = 1000, height= 95)
